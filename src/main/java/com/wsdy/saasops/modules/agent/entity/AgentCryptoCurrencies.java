...
@Setter
@Getter
@ApiModel(value = "代理加密货币钱包", description = "代理加密货币钱包")
@Table(name = "agy_cryptocurrencies")
public class AgentCryptoCurrencies implements Serializable {
	...
	@Transient
	@ApiModelProperty(value = "钱包地址")
	private String walletAddressEncryption;
}