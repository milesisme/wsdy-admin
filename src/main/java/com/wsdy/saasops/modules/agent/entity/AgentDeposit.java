...
@Setter
@Getter
@ApiModel(value = "AgentDeposit", description = "AgentDeposit")
@Table(name = "agy_deposit")
public class AgentDeposit implements Serializable {
    ...
    @ApiModelProperty(value = "0 线上入款 ,1 公司入款 ,2 个人二维码  3加密货币 4代理充值")
