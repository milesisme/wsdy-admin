...
@Setter
@Getter
public class ExportAgentSubMbrDto {


    @Excel(name = "会员名", width = 20, orderNum = "1")
    ...
    @Excel(name = "提款", width = 20, orderNum = "7")
    ...
    @Excel(name = "总红利", width = 20, orderNum = "10")
    private BigDecimal totalBonusAmount;    //总红利

    @Excel(name = "总返利", width = 20, orderNum = "11")
    private BigDecimal totalRebate;     //总返点

    @Excel(name = "赢亏", width = 20, orderNum = "12")
    private BigDecimal totalPayout;      //总派彩

    @Excel(name = "总任务返利", width = 20, orderNum = "13")
    private BigDecimal totalTaskBonus;  // 总任务返利

    @Excel(name = "奖池派彩", width = 20, orderNum = "14")
